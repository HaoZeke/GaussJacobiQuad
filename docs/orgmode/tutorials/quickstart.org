...
- Method may be =auto=, =rec=, =gw=, =algo665=, =algo665_dc=, =sturm=, =glr=,
  =bogaert=, or a =*_caf= name (=rec_caf=, =sturm_caf=, =glr_caf=, =bogaert_caf=,
  =algo665_dc_caf=, …). =auto= selects =*_caf= when multi-image.
