#+TITLE: Methods, ranking, and auto policy
...
| =glr= / =glr_caf= | Prüfer *phase-by-π march* + Newton | full Jacobi (high α,β via Bessel first-root) | sequential chain; CAF = broadcast |
