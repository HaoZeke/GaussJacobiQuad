...
Summary
  bbdir/gjp_quad 5 2. 3. "gw" ran
   ...
   88.42 ± 28.08 times faster than python scripts/sympy_gauss_jac.py --npts 5 --alpha 2 --beta 3 --n_dig 15
...
| ~sympy_gauss_jac.py --npts 5 --alpha 2 --beta 3 --n_dig 15~ | 219.0 ± 3.3 |    216.4 |    224.2 | 88.42 ± 28.08 |
